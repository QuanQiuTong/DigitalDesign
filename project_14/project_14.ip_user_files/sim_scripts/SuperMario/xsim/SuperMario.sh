...
#
# Script generated by Vivado on Thu Dec 14 21:55:47 +0800 2023
...
#
# Usage        : SuperMario.sh
#                SuperMario.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SuperMario.sh [-reset_run]
#                SuperMario.sh [-reset_log]
#                SuperMario.sh [-help]
#
...
# script info
echo -e "SuperMario.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SuperMario.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SuperMario xil_defaultlib.SuperMario xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SuperMario.wdb xsim.dir libdpi.so)
...
Usage: SuperMario.sh [-step]\n\
Usage: SuperMario.sh [-lib_map_path]\n\
Usage: SuperMario.sh [-reset_run]\n\
Usage: SuperMario.sh [-reset_log]\n\
Usage: SuperMario.sh [-keep_index]\n\
