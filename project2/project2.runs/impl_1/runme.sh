...
HD_PWD='C:/Users/Fu_Quantong/project2/project2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log x7seg_Top_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source x7seg_Top_2.tcl -notrace
