...
HD_PWD='C:/Users/Fu_Quantong/project2/project2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log x7seg_Top_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source x7seg_Top_2.tcl
