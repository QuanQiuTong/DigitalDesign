...
#
# Script generated by Vivado on Fri Dec 22 16:39:17 +0800 2023
...
#
# Usage        : Fudan320x320.sh
#                Fudan320x320.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Fudan320x320.sh [-reset_run]
#                Fudan320x320.sh [-reset_log]
#                Fudan320x320.sh [-help]
#
...
#                script (type 'Fudan320x320.sh -help' for more information).
#
...
# script info
echo -e "Fudan320x320.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Fudan320x320.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Fudan320x320 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Fudan320x320 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Fudan320x320_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: Fudan320x320.sh [-step]\n\
Usage: Fudan320x320.sh [-lib_map_path]\n\
Usage: Fudan320x320.sh [-reset_run]\n\
Usage: Fudan320x320.sh [-reset_log]\n\
Usage: Fudan320x320.sh [-keep_index]\n\
